...
import static model.DB.E;
import static model.DB.a;
...
public class MainMenuController implements Initializable {
    ...
    public void update(Event e) throws IOException {
        ...
        if (EditTable.equals("_Edit Meals")) {
        ...
        URL url = new File("E:\\Codes\\project\\Restaurant-Management-master\\src\\view\\Edit.fxml").toURI().toURL();
        Parent root = FXMLLoader.load(url);
        Scene scene = new Scene(root);
